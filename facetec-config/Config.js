export var Config = (function () {
    ...
    // var DeviceKeyIdentifier = "dl1m3Rrdjkjm8p5BTUU1UfIualvA1HKp";
    var DeviceKeyIdentifier = "dlu4dG4ibRiU2D5Xh4XkDlXwvkelQf2k";
    ...
    var ProductionKeyText =
        "{  \"domains\": \"igcbextmfg.ifincloud.io,igcbdemos16.intellectfabric.io,igcbdemos19.intellectfabric.io\",  \"expiryDate\": \"2025-06-10\",  \"key\": \"003046022100c4de01dca3c37b65e50b17dd764917da09598849371c6b0253db9bd03ed1314c022100ae795a898276b306bd771dc6e9a914201080fee5d5d9d3af1e08e2a3cff63e57\"}";
    ...
    function initializeFromAutogeneratedConfig(FaceTecSDK, callback) {
        ...
        if(this.IsProduction=="1"){
            FaceTecSDK.initializeInProductionMode(this.ProductionKeyText,this.DeviceKeyIdentifier,this.PublicFaceScanEncryptionKey,
                ...
                console.log("production mode turned on");
        }
        else{
            FaceTecSDK.initializeInDevelopmentMode(this.DeviceKeyIdentifier, this.PublicFaceScanEncryptionKey,
                ...
                console.log("development mode turned on");
        }
    };
    ...
    function retrieveConfigurationWizardCustomization(FaceTecSDK) {
        var sdkImageDirectory = "./assets/FaceTec_images/";
        
        // For Color Customization
        var outerBackgroundColor = "#ffffff";
        var frameColor = "#ffffff";
        var borderColor = "#00a10b";
        var ovalColor = "#00a10b";
        var dualSpinnerColor = "#00a10b";
        var textColor = "#00a10b";
        var buttonAndFeedbackBarColor =  "#00a10b";
        var buttonAndFeedbackBarTextColor = "#ffffff";
        var buttonColorHighlight = "#b3dfb6";
        var buttonColorDisabled = "#9fd6a2";
