...
export class NPSSContactViewingHelper extends BaseFpxFormHelper<NPSSContactViewingState>{
  ...
  constructor(private nPSSContactViewingService: NpsscontactviewingService, private _httpProvider: HttpProviderService, private _router: Router,
    private appConfig: AppConfigService, private deviceDetectorService: DeviceDetectorService, private phoneBookService: PhoneBookService) {
  ...
  onOtherOption() {
    let service = this.appConfig.getServiceDetails("RETAILSENDMONEYSTART");
