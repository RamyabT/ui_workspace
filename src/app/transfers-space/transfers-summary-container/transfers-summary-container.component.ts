...
@Component({
  selector: 'transfers-summary-container',
  templateUrl: './transfers-summary-container.component.html',
  styleUrls: ['./transfers-summary-container.component.scss']
})
export class TransfersSummaryContainerComponent implements OnInit {
