...
@Component({
  selector: 'transfers-module-header',
  templateUrl: './transfers-module-header.component.html',
  styleUrls: ['./transfers-module-header.component.scss']
})
export class TransfersModuleHeaderComponent implements OnInit {
