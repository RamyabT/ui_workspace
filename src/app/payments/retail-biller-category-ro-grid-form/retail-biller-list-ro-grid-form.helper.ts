...
export class RetailBillerCategoryRoGriFormState extends BaseFpxComponentState {
...
@Injectable()
export class RetailBillerCategoryRoGriFormHelper extends BaseFpxFormHelper<RetailBillerCategoryRoGriFormState>{
   ...
   constructor( private billerListRoGriFormService: BillerService, private _httpProvider : HttpProviderService,private _router: Router) 
    {
        super(new RetailBillerCategoryRoGriFormState());
    }
