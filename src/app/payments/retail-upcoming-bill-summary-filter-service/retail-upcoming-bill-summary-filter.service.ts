...
import { map, Observable, of,catchError } from 'rxjs';
 import { RetailupcomingBillSummaryexfilter, RetailupcomingBillSummaryexfilterMaintanence } from './retail-upcoming-bill-summary-filter.model';
@Injectable()
export class RetailupcomingBillSummaryexfilterService implements BaseFpxDataService<any> {
 ...
 patch(payload: RetailupcomingBillSummaryexfilter,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
