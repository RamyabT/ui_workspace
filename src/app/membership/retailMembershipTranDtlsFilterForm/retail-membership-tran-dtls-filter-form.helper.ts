...
import { Retailmembershiptrandtlsfilterform } from "../retailmembershiptrandtlsfilterform-service/retailmembershiptrandtlsfilterform.model";
...
export class retailmembershiptrandtlsfilterformState extends BaseFpxComponentState {
...
@Injectable()
export class retailmembershiptrandtlsfilterformHelper extends BaseFpxFormHelper<retailmembershiptrandtlsfilterformState>{

   constructor( private retailmembershiptrandtlsfilterformService: RetailmembershiptrandtlsfilterformService, private _httpProvider : HttpProviderService,
    ...
    {
        super(new retailmembershiptrandtlsfilterformState());
    }
 ...
 this.addValueChangeHandler("rangeType", this.handleRangeTypeOnvalueChange);
  ...
  public override preSubmitInterceptor(payload: Retailmembershiptrandtlsfilterform):any {
     // WRITE CODE HERE TO HANDLE 
    return payload;
  }
  
  
 public override postDataFetchInterceptor(payload: Retailmembershiptrandtlsfilterform){
   // WRITE CODE HERE TO HANDLE 
  return payload;
}
  ...
  let routingInfo: RoutingInfo = new RoutingInfo();
    ...
    if (response.success) {
      routingInfo.setQueryParams({
        transRef: response.success?.body?.retailmembershiptrandtlsfilterform,
        status: "success",
      });
