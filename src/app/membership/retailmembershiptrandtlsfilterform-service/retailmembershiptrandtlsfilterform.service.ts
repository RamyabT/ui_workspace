...
import { map, Observable, of,catchError } from 'rxjs';
 import { Retailmembershiptrandtlsfilterform, RetailmembershiptrandtlsfilterformMaintanence } from './retailmembershiptrandtlsfilterform.model';
@Injectable()
export class RetailmembershiptrandtlsfilterformService implements BaseFpxDataService<any> {
 ...
 patch(payload: Retailmembershiptrandtlsfilterform,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
