...
@Component({
  selector: 'edocument-aside-bar',
  templateUrl: './edocument-aside-bar.component.html',
  styleUrls: ['./edocument-aside-bar.component.scss']
})
export class eDocumentAsideBarComponent implements OnInit {
  serviceCode : string = "";
