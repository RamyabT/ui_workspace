...
import { map, Observable, of,catchError } from 'rxjs';
 import { Retaildctransactionexfilter, RetaildctransactionexfilterMaintanence } from './retaildctransactionexfilter.model';
@Injectable()
export class RetaildctransactionexfilterService implements BaseFpxDataService<any> {
 ...
 patch(payload: Retaildctransactionexfilter,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
