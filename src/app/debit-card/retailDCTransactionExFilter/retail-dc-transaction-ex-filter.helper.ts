...
import { Retaildctransactionexfilter } from "../retaildctransactionexfilter-service/retaildctransactionexfilter.model";
...
@Injectable()
export class RetailDcTransactionExFilterHelper extends BaseFpxFormHelper<RetailDcTransactionExFilterState> {

  constructor(private retailDcTransactionExFilterService: RetaildctransactionexfilterService, private _httpProvider: HttpProviderService, private _router: Router,
