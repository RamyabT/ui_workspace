...
import { map, Observable, of,catchError } from 'rxjs';
 import { Retaildctransactiondownloadfilter, RetaildctransactiondownloadfilterMaintanence } from './retaildctransactiondownloadfilter.model';
@Injectable()
export class RetaildctransactiondownloadfilterService implements BaseFpxDataService<any> {
