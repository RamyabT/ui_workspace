...
export class WalletRequestedSummaryState extends BaseFpxComponentState {
...
@Injectable()
export class WalletRequestedSummaryHelper extends BaseFpxFormHelper<WalletRequestedSummaryState>{
  ...
  constructor(
    ...
    super(new WalletRequestedSummaryState());
  }
  ...
  filter() {
    ...
    modal.setComponent(WalletFilterReceivedFormComponent);
  ...
  contextmenuModelAfterClose: FpxModalAfterClosed = (payload: any, addtionalData: any) => {
    ...
    this.setGridCriteria('requestSummaryGrid', criteriaQuery);
  ...
  initiateNewTransaction() {
    ...
    let service = this._appConfig.getServiceDetails('RETAILWALLETREQMONEY');
