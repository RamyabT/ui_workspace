...
import { walletreceivedinfo } from '../trans-history-service/walletreceive.model';
 

@Injectable()
export class WalletReceivedSummaryRoGridHelper extends BaseFpxRoGridHelper {
  constructor(
    private _router: Router,
    private _httpProvider: HttpProviderService,
    private _currencyFormatter: FpxCurrenyFormatterPipe,
    @Inject(MAT_DIALOG_DATA) private _dialogData: any,
    private _WallethistroyService: WalletreceiveService,
  ...
  private transformScheduleType: GridTransformFn<walletreceivedinfo> = (payload: walletreceivedinfo) => {
  ...
  override doPreInit(): void {
    ...
    this.setNgTemplateName('walletReceivedListTmplt');
  ...
  override postFindallInterceptor = (payload: any) => {
    let rowData: walletreceivedinfo[] = [];
    let _date = "";
