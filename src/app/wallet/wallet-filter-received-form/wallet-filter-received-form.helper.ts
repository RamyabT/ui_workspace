...
export class WalletFilterReceiveFormState extends BaseFpxComponentState {
...
@Injectable()
export class WalletFilterReceiveFormHelper extends BaseFpxFormHelper<WalletFilterReceiveFormState> {
  ...
  constructor(private retailFilterTransactionService: WallethistroyService, private _httpProvider: HttpProviderService, private _router: Router,
    ...
    super(new WalletFilterReceiveFormState());
  }
