...
import { map, Observable, of,catchError } from 'rxjs';
 import { Retailetransferhistoryfilter, RetailetransferhistoryfilterMaintanence } from './retailetransferhistoryfilter.model';
@Injectable()
export class RetailetransferhistoryfilterService implements BaseFpxDataService<any> {
 ...
 patch(payload: Retailetransferhistoryfilter,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
