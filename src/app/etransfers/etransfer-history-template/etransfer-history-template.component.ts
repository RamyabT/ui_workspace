...
@Component({
  selector: 'app-etransfer-history-template',
  templateUrl: './etransfer-history-template.component.html',
  styleUrls: ['./etransfer-history-template.component.scss']
})
export class EtransferHistoryTemplateComponent extends DepPanningComponent implements OnInit {
  ...
  public override doPreInit(): void {
    // this.selectedData.status = this.selectedData.status?this.selectedData.status:this.selectedData.paymentStatus;
    let leftActions = 2;
    let rightActions = 2;
