...
export class RetailEtransferDeclineMoneyFormState extends BaseFpxComponentState {
...
@Injectable()
export class RetailEtransferDeclineMoneyFormHelper extends BaseFpxFormHelper<RetailEtransferDeclineMoneyFormState> {
  autoDepositFlag!: FormGroup;
  isDisabled: boolean = true;
  constructor(private retailEtransferDeclineMoneyFormService: EtransferService,
    ...
    super(new RetailEtransferDeclineMoneyFormState());
  }
