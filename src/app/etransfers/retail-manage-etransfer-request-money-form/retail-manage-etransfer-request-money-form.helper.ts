...
export class RetailManageEtransferRequestMoneyFormState extends BaseFpxComponentState {
...
@Injectable()
export class RetailManageEtransferRequestMoneyFormHelper extends BaseFpxFormHelper<RetailManageEtransferRequestMoneyFormState> {
  FieldId_1!: FormArray;
  ...
  constructor(
    ...
    super(new RetailManageEtransferRequestMoneyFormState());
  }
  ...
  // OneOffSendMoney(){
  //   this._router.navigate(
  //     ['etransfers-space', 'entry-shell', 'etransfers', 'retail-etransfer-request-money-form'],
  //      {
  //       queryParams:{
