...
export class RetailManageEtransferContactlogFormState extends BaseFpxComponentState {
...
@Injectable()
export class RetailManageEtransferContactlogFormHelper extends BaseFpxFormHelper<RetailManageEtransferContactlogFormState> {
  FieldId_1!: FormArray;
  ...
  constructor(
    ...
    super(new RetailManageEtransferContactlogFormState());
  }
