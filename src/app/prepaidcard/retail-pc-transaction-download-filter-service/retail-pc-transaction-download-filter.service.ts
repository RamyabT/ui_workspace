...
import { map, Observable, of,catchError } from 'rxjs';
 import { RetailPctransactiondownloadfilter, RetailPctransactiondownloadfilterMaintanence } from './retail-pc-transaction-download-filter.model';
@Injectable()
export class RetailPctransactiondownloadfilterService implements BaseFpxDataService<any> {
 ...
 patch(payload: RetailPctransactiondownloadfilter,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
