...
import { Retaildctransactionexfilter } from "../retail-pc-transaction-filter-service/retail-pc-transaction-filter.model";
...
@Injectable()
export class RetailpcTransactionFilterHelper extends BaseFpxFormHelper<RetailDcTransactionExFilterState>{
 ...
 public handleFormOnLoad() {
  ...
  if(this._dialogData.minAmount) this.setValue('minAmount', this._dialogData.minAmount);
  if(this._dialogData.maximumAmount) this.setValue('maximumAmount', this._dialogData.maximumAmount);
