...
import { map, Observable, of,catchError } from 'rxjs';
 import { Retailtaxformfilterform, RetailtaxformfilterformMaintanence } from './retailtaxformfilterform.model';
@Injectable()
export class RetailtaxformfilterformService implements BaseFpxDataService<any> {
 ...
 patch(payload: Retailtaxformfilterform,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
