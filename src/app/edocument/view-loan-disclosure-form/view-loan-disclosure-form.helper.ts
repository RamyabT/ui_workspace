...
export class ViewLoanDisclosureFormComponentState extends BaseFpxComponentState {
...
@Injectable()
export class ViewLoanDisclosureFormComponentHelper extends BaseFpxFormHelper<ViewLoanDisclosureFormComponentState>{
  dateFrom: any;
  dateTo: any;
  formatdateTo: any;
  formatdateFrom: any
  loanDisclosureApiReceived: boolean = false;
  ...
  constructor(
    ...
    super(new ViewLoanDisclosureFormComponentState());
  ...
  onLoadForm(){
    this.loanDisclosureApiReceived = false;
  ...
  loanDisclosureGridEvent($event: any) {
    if ($event.eventName == 'afterDataFetch') {
      this.loanDisclosureApiReceived = true;
