...
import { BaseFpxDataService, CreateFn, CriteriaQuery, FindAllFn, FindByKeyFn, FpxIHttpOption, HttpProviderService, HttpRequest, IHttpSuccessPayload, ILookupResponse, LookUpFn, ModifyFn } from '@fpx/core';
import { Observable, catchError, map, of } from 'rxjs';

@Injectable({
  providedIn: 'root'
})
export class RetailProductSelectionListControlService implements BaseFpxDataService<any>{
