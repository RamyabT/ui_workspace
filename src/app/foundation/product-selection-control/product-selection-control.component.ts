...
import { ProductSelectionControlHelper } from './product-selection-control.helper';
import { of } from 'rxjs';
import { DomSanitizer } from '@angular/platform-browser';
declare const window: any;

@Component({
  selector: 'app-product-selection-control',
  templateUrl: './product-selection-control.component.html',
  styleUrls: ['./product-selection-control.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => ProductSelectionControlComponent),
      multi: true
    }
  ]
})

export class ProductSelectionControlComponent extends BaseFpxControlComponent {
  ...
  constructor(
    ...
    private _service: ProductSelectionControlService,
    private _productSelectionControlHelper: ProductSelectionControlHelper,
    private sanitizer: DomSanitizer) {
    super(controlContainer, changeDetectorRef)
    window["ProductSelectionControlComponent"] = this;
  }
