...
import type { FaceTecSessionResult, FaceTecFaceScanResultCallback, FaceTecFaceScanProcessor } from "facetec-core-sdk/FaceTecSDK.js/FaceTecPublicApi";
...
export class EnrollmentProcessor implements FaceTecFaceScanProcessor {
  ...
  public processSessionResultWhileFaceTecSDKWaits = (sessionResult: FaceTecSessionResult, faceScanResultCallback: FaceTecFaceScanResultCallback): void => {
    ...
    if(sessionResult.status !== FaceTecSDK.FaceTecSessionStatus.SessionCompletedSuccessfully) {
      console.log("Enrolluser was not completed successfully, cancelling.  Session Status: " + FaceTecSDK.FaceTecSessionStatus[sessionResult.status]);
  ...
  public onFaceTecSDKCompletelyDone = (): void => {
    ...
    // Log success message
    if(this.success) {
      console.log("EnrollUser Confirmed");
    }
    ...
    this.FaceTechSKControllerReference.onComplete(this.latestSessionResult, null, this.latestNetworkRequest.status);
  };
