...
import type { FaceTecIDScanResult, FaceTecIDScanResultCallback, FaceTecIDScanProcessor } from "facetec-core-sdk/FaceTecSDK.js/FaceTecPublicApi";
...
export class PhotoIDScanProcessor implements FaceTecIDScanProcessor {
  ...
  public onFaceTecSDKCompletelyDone = (): void => {
    ...
    this.FaceTechSKControllerReference.onComplete(null, this.latestIDScanResult, this.latestNetworkRequest.status);
  };
