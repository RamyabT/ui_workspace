...
import { BaseFpxRoGridHelper, CriteriaQuery, FpxCurrenyFormatterPipe, GridTransformFn, ToolBar } from "@fpx/core";
import { TranslateService } from "@ngx-translate/core";
import moment from "moment";

@Injectable()
export class MemberNextAllowanceRoGridHelper extends BaseFpxRoGridHelper {
     constructor(
       ...
       override doPreInit(): void {
           this.setNgTemplateName('nextAllowanceDashboardTmplt');
