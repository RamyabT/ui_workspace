...
import { map, Observable, of,catchError } from 'rxjs';
 import { Goallog, GoallogMaintanence } from '../goallog-service/goallog.model';
import { Fbgoal } from './fbgoal.model';
@Injectable()
export class FbgoalserviceService implements BaseFpxDataService<any> {
      ...
      return () => {
       ...
       // httpRequest.addQueryParameter('childAccNo', 202500001985);
        ...
        return this._httpProvider
          ...
          .pipe(
            map(
              (res: IHttpSuccessPayload<Fbgoal>) =>{
               return{
                data:res.body.goals || [],
