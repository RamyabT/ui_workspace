...
export class RetailFilterTransactionState extends BaseFpxComponentState {
...
@Injectable()
export class RetailFilterTransactionHelper extends BaseFpxFormHelper<RetailFilterTransactionState> {

  constructor(private retailFilterTransactionService: CompletedpymntsService, private _httpProvider: HttpProviderService, private _router: Router,
    @Inject(MAT_DIALOG_DATA) private _dialogData: any,
    private _dialogRef: MatDialogRef<any>,) {
    super(new RetailFilterTransactionState());
  }
