...
import { AedAccountNumberControlComponent } from "./aed-account-number-control.component";


@Injectable()
export class AedBeneficiaryValidator {
    constructor(
          ...
          .pipe(
            map((res: IHttpSuccessPayload<BeneficiariesMaintanence>) =>{
                ...
                eventEmitter.emit({
                    ...
                    payload: {
                      'accountNumber':AedAccountNumberControlComponent
                    }
