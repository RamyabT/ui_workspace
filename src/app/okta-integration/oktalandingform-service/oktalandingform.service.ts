...
import { map, Observable, of,catchError } from 'rxjs';
 import { Oktalandingform, OktalandingformMaintanence } from './oktalandingform.model';
@Injectable()
export class OktalandingformService implements BaseFpxDataService<any> {
 ...
 patch(payload: Oktalandingform,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
