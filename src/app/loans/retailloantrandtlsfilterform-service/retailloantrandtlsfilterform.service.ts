...
import { map, Observable, of,catchError } from 'rxjs';
 import { Retailloantrandtlsfilterform, RetailloantrandtlsfilterformMaintanence } from './retailloantrandtlsfilterform.model';
@Injectable()
export class RetailloantrandtlsfilterformService implements BaseFpxDataService<any> {
 ...
 patch(payload: Retailloantrandtlsfilterform,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
