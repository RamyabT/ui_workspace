...
export class RetailLoanTranDtlsDownloadFilterFormState extends BaseFpxComponentState {
...
@Injectable()
export class RetailLoanTranDtlsDownloadFilterFormHelper extends BaseFpxFormHelper<RetailLoanTranDtlsDownloadFilterFormState> {

  constructor(private retailLoanTranDtlsDownloadFilterFormService: RetailloantrandtlsdownloadfilterformService,
    ...
    super(new RetailLoanTranDtlsDownloadFilterFormState());
  }

  override doPreInit(): void {
    this.hideShellActions();
    this.setServiceCode("RETAILOANTRANDTLSFILTER");
  ...
  public override preSubmitInterceptor(payload: Retailloantrandtlsdownloadfilterform): any {
    // WRITE CODE HERE TO HANDLE 
    return payload;
  }


  public override postDataFetchInterceptor(payload: Retailloantrandtlsdownloadfilterform) {
    // WRITE CODE HERE TO HANDLE 
    return payload;
  }
  ...
  public onDownloadClick: BaseFpxControlEventHandler = (payload: any) => {
    ...
    if (this.getValue('downloadFileFormat') == 1) {
      this.commonService.downloadLoanStatement(criteriaQuery).subscribe({
        next: (response: any) => {
      ...
      this.commonService.downloadLoanAccountStatement(criteriaQuery).subscribe({
        next: (response: any) => {
          if (this.deviceDetectorService.isHybrid()) {
            this.hideSpinner();
            this._fileOpener.openPDF(
            ...
            const downloadLink = document.createElement("a");
            downloadLink.href = documentURL;
            const fileName = "LoanDetails.xls";
            downloadLink.download = fileName;
            // downloadLink.click();
          }
        },
      ...
      this.commonService.downloadLoanAccountStatementOTN(criteriaQuery).subscribe({
        next: (response: any) => {
          if (this.deviceDetectorService.isHybrid()) {
            this.hideSpinner();
            this._fileOpener.openPDF(
            ...
            const downloadLink = document.createElement("a");
            downloadLink.href = documentURL;
            const fileName = "LoanDetails.csv";
            downloadLink.download = fileName;
            // downloadLink.click();
          }
        },
      ...
      this.commonService.downloadLoanQFXAccountStatement(criteriaQuery).subscribe({
        next: (response: any) => {
          if (this.deviceDetectorService.isHybrid()) {
            this.hideSpinner();
            this._fileOpener.openPDF(
            ...
            const downloadLink = document.createElement("a");
            downloadLink.href = documentURL;
            const fileName = "LoanDetails.qfx";
            downloadLink.download = fileName;
            // downloadLink.click();
          }
        },
      ...
      this.commonService.downloadOFXLoanAccountStatement(criteriaQuery).subscribe({
        next: (response: any) => {
          if (this.deviceDetectorService.isHybrid()) {
            this.hideSpinner();
            this._fileOpener.openPDF(
            ...
            const downloadLink = document.createElement("a");
            downloadLink.href = documentURL;
            const fileName = "LoanDetails.ofx";
            downloadLink.download = fileName;
            // downloadLink.click();
          }
        },
      ...
      this.commonService.downloadQBOLoanAccountStatement(criteriaQuery).subscribe({
        next: (response: any) => {
          if (this.deviceDetectorService.isHybrid()) {
            this.hideSpinner();
            this._fileOpener.openPDF(
            ...
            const downloadLink = document.createElement("a");
            downloadLink.href = documentURL;
            const fileName = "LoanDetails.qbo";
            downloadLink.download = fileName;
            // downloadLink.click();
          }
        },
  ...
  public override postSubmitInterceptor(response: any): RoutingInfo {
    ...
    if (response.success) {
      routingInfo.setQueryParams({
        transRef: response.success?.body?.retailloantrandtlsdownloadfilterform,
        status: "success",
      });
