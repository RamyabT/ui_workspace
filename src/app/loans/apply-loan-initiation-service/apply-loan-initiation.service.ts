...
import { Applyloaninitiation } from './apply-loan-initiation.model';
@Injectable()
export class ApplyloaninitiationService implements BaseFpxDataService<any> {
 ...
 patch(payload: Applyloaninitiation,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
