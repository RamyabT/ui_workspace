...
import { map, Observable, of,catchError } from 'rxjs';
 import { Retailloantrandtlsdownloadfilterform, RetailloantrandtlsdownloadfilterformMaintanence } from './retailloantrandtlsdownloadfilterform.model';
@Injectable()
export class RetailloantrandtlsdownloadfilterformService implements BaseFpxDataService<any> {
 ...
 patch(payload: Retailloantrandtlsdownloadfilterform,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
