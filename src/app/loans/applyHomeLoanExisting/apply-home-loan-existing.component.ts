...
import { applyHomeLoanHelper } from '../applyHomeLoan/apply-home-loan.helper';
import { applyHomeLoanExistingHelper, applyHomeLoanState } from './apply-home-loan-existing.helper';



@Component({
  selector: 'app-apply-home-loan',
  templateUrl: './apply-home-loan-existing.component.html',
  styleUrls: ['./apply-home-loan-existing.component.scss'],
  providers: [applyHomeLoanHelper,
    {
      provide: NG_VALUE_ACCESSOR,
      multi: true,
      useExisting: forwardRef(() => applyHomeLoanExistingComponent)
    },
    {
...
export class applyHomeLoanExistingComponent extends BaseFpxFormComponent<applyHomeLoanExistingHelper, applyHomeLoanState> {
  constructor(
    @Optional() controlContainer: ControlContainer,
    formBuilder: FormBuilder,
    private router: Router,
    public applyHomeLoanExistingHelper: applyHomeLoanExistingHelper,
    public applyloanService: ApplyloanService,
    private validatorService: ValidatorService,

  ) {
    super(formBuilder, router, controlContainer, applyHomeLoanExistingHelper);
