...
export class RewardsTransactionSummaryState extends BaseFpxComponentState {
...
@Injectable()
export class RewardsTransactionSummaryHelper extends BaseFpxFormHelper<RewardsTransactionSummaryState>{
  ...
  constructor(
    ...
    super(new RewardsTransactionSummaryState());
  }
