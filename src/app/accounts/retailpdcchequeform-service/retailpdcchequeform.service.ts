...
import { Retailpdcchequeform, RetailpdcchequeformMaintanence } from './retailpdcchequeform.model';
@Injectable()
export class RetailpdcchequeformService implements BaseFpxDataService<any> {
 ...
 patch(payload: Retailpdcchequeform,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
