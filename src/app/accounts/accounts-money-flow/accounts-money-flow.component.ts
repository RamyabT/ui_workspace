...
@Component({
  selector: 'app-accounts-money-flow',
  templateUrl: './accounts-money-flow.component.html',
  styleUrls: ['./accounts-money-flow.component.scss']
})
export class AccountsMoneyFlowComponent implements OnInit {
