...
//  import {  ChequeStatusInquiry } from '../../accounts/retail-cheque-status-inquiry-display-grid/retail-cheque-status-inquiry-display-grid.model';
import { Retailchequestatusinquiryform, RetailchequestatusinquiryformMaintanence } from './retailchequestatusinquiryform.model';
@Injectable()
export class RetailchequestatusinquiryformService implements BaseFpxDataService<any> {
 ...
 patch(payload: Retailchequestatusinquiryform,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
