...
import { map, Observable, of,catchError } from 'rxjs';
 import { Retailcasatrandtlsfilterform, RetailcasatrandtlsfilterformMaintanence } from './retailcasatrandtlsfilterform.model';
@Injectable()
export class RetailcasatrandtlsfilterformService implements BaseFpxDataService<any> {
 ...
 patch(payload: Retailcasatrandtlsfilterform,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
