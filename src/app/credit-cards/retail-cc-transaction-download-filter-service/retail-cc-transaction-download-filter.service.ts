...
import { map, Observable, of,catchError } from 'rxjs';
 import { Retaildctransactiondownloadfilter, RetaildctransactiondownloadfilterMaintanence } from './retail-cc-transaction-download-filter.model';
@Injectable()
export class RetailcctransactiondownloadfilterService implements BaseFpxDataService<any> {
 ...
 patch(payload: Retaildctransactiondownloadfilter,httpOption: Map<keyof FpxIHttpOption, Map<string, any>> = new Map()): PatchFn<any> {
    throw new Error('Method not implemented.');
  }
