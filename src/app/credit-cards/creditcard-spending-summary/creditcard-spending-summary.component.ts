...
@Component({
  selector: 'app-creditcard-spending-summary',
  templateUrl: './creditcard-spending-summary.component.html',
  styleUrls: ['./creditcard-spending-summary.component.scss']
})
export class CreditcardSpendingSummaryComponent implements OnInit {
