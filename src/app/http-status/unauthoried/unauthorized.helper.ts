...
export class UnauthorizedState extends BaseFpxComponentState {

}

@Injectable()
export class UnauthorizedHelper extends BaseFpxFormHelper<UnauthorizedState> {
  constructor(
    ...
    super(new UnauthorizedState());
  }

  override doPreInit() {
    this.removeShellBtn('BACK');
    this.addShellButton('unauthorizedForm.login','LOGIN','primary','DISPLAY','button');
