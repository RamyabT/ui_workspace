...
@Component({
  selector: "app-retail-track-goals-template",
  templateUrl: "./retail-track-goals-template.component.html",
  styleUrls: ["./retail-track-goals-template.component.scss"],
})
export class RetailTrackGoalsTemplateComponent extends DepPanningComponent implements OnInit {
  goalData: any;
  ...
  editGoal(selectedData: any) {
    let service = this._appConfig.getServiceDetails('RETAILPFMGOALSREQ');
