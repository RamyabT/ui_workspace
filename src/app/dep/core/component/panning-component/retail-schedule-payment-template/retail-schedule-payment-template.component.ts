...
@Component({
  selector: "app-retail-schedule-payment-template",
  templateUrl: "./retail-schedule-payment-template.component.html",
  styleUrls: ["./retail-schedule-payment-template.component.scss"],
})
export class RetailSchedulePaymentTemplateComponent extends DepPanningComponent {
  ...
  deleteRowData($event:any,selectedData: TempScheduleRep) {
    ...
    if (selectedData.nextPaymentDate <= currentDate) {
      ...
      fpxModal.setData({
        ...
        message: "RetailSchedulePaymentTemplateComponent.confirmMsg",
