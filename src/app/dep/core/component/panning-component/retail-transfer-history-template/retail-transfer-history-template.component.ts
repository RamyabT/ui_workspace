...
@Component({
  selector: "app-retail-transfer-history-template",
  templateUrl: "./retail-transfer-history-template.component.html",
  styleUrls: ["./retail-transfer-history-template.component.scss"],
})
export class RetailTransferHistoryTemplateComponent extends DepPanningComponent {
  constructor(
  ...
  doShare($event: any, rowData: any) {
    ...
    "Beneficiary A/c: " + rowData?.beneAccount + "\n" +
    "Beneficiary Name: " + rowData?.beneName + "\n" +
    "Credit Amount: "  + " " + rowData.paymentAmount  +" "+ rowData.paymentCurrency+ "\n" +
    "Initiated On: " + rowData.initiationDate + "\n" 
